  ...
  return (
    <Card height="h-[31.875rem]" backgroundColor="bg-white">
      ...
      <div className="overflow-hidden rounded-md bg-grey-100 p-1">
        <div
          style={{ width: "20%" }}
          className="h-6 rounded-sm bg-secondary-cyan"
        />
      </div>
      <div className="grid grid-cols-2 gap-4 mt-4 mb-5">
        <CategoryCard category="Spent" amount={150} color="secondary-cyan" />
        <CategoryCard category="Remaining" amount={600} color="beige-100" />
      </div>
