    ...
    <Card height="h-[18.938rem]" backgroundColor="bg-white">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded-full bg-secondary-purple"></div>
          <h2 className="text-preset-2 font-semibold">Holiday</h2>
        </div>
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        <p className="text-preset-1 font-semibold">$531.00</p>
      </div>
      <div className="overflow-hidden rounded-md bg-grey-100 mt-4">
        <div
          style={{ width: "36.8%" }}
          className="h-2 rounded-md bg-secondary-purple"
        />
      </div>
      <div className="flex justify-between items-center mt-2">
        <p className="text-preset-5 text-grey-500 font-semibold">36.8%</p>
        <p className="text-preset-5 text-grey-500">Target of $1440</p>
      </div>
