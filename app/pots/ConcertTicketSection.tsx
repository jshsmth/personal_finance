  ...
  return (
    <Card height="h-[18.938rem]" backgroundColor="bg-white">
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        <p className="text-preset-1 font-semibold">$110.00</p>
      </div>
      <div className="overflow-hidden rounded-md bg-grey-100 mt-4">
        <div
          style={{ width: "73.3%" }}
          className="h-2 rounded-md bg-secondary-navy"
        />
      </div>
      <div className="flex justify-between items-center mt-2">
        <p className="text-preset-5 text-grey-500 font-semibold">73.3%</p>
        <p className="text-preset-5 text-grey-500">Target of $150</p>
      </div>
