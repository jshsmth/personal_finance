    ...
    <Card height="h-[18.938rem]" backgroundColor="bg-white">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-preset-2 font-semibold">Savings</h2>
        </div>
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        <p className="text-preset-1 font-semibold">$159.00</p>
      </div>
      ...
      <div className="flex justify-between items-center mt-2">
        <p className="text-preset-5 text-grey-500 font-semibold">7.95%</p>
